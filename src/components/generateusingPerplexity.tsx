...
const text = {
    ...
    additionaldata: "totally number strectured directory like 1. ........ 2. ......... 3. .........(Provide figures, sketches, pictures, graphs, statistics, lists, sequences etc.) (up to 5 pages)",
